...
public class Main {
    public static void main(String[] args) {
        ...
        ScannerUtils scannerUtilsFirstInt = new ScannerUtils();
        ScannerUtils scannerUtilsSecondInt = new ScannerUtils();
        ...
        int x = scannerUtilsFirstInt.readOnlyIntegers(scanner);

        System.out.println("Please input second integer:");
        int y = scannerUtilsSecondInt.readOnlyIntegers(scanner);
